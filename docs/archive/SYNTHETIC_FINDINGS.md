...
node scripts/synthetic-backtest.js --optimal     # Recommended settings
node scripts/synthetic-backtest.js --conservative
node scripts/synthetic-backtest.js --flat        # 1-contract flat sizing
```
