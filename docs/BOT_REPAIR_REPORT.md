...
After adding future history, use `node scripts/replay-history.js --download-spot` to align the new reference data. See `docs/RESEARCH_WORKFLOW.md` for all assumptions and output locations.
