...
The matching config/research/research-demo-active.json can be passed to scripts/replay-history.js with --config. It does not replace the frozen research policy.
