...
const {association}=require('#src/research/metrics');
...
async function main(){
  ...
  const root=require('#src/config/paths').root,file=path.join(root,'data/demo/telemetry.sqlite');
  ...
  try{
    if(args.includes('--resolve')) {
      ...
      const client=new(require('#src/exchange/kalshi-client'))(config,{});
