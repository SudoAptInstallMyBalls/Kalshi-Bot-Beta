...
const { replay, fee, asOf, spotContext } = require('#src/research/history-replay');
...
const { mean, variance, association, tradeMetrics, groups, dailySeries, performance } = require('#src/research/metrics');
async function main() {
  ...
  try {
    ...
    const sources={strategy:['src/agents/skills/analysis/signal-generator.js','src/agents/skills/analysis/trend-analysis.js','src/strategy/trend-indicator.js'],
      risk:['src/agents/skills/trading/risk-manager.js','src/risk/trading-safety.js'],
      execution:['src/agents/skills/trading/position-manager.js','src/execution/order-manager.js'],ml:['src/ml/ml-pipeline.js']};
