...
`SECURITY_SETUP.md`, storage comments in `bot/db.js`, `lib/ml-pipeline.js`,
`agents/skills/analysis/ml-signal-scorer.js`, and key-loading text in `bot/kalshi.js`.
...
Changed: `bot/db.js`, `lib/ml-pipeline.js`, new `lib/ml-write-buffer.js`,
`agents/skills/analysis/ml-signal-scorer.js`, `agents/core/master-agent.js`, and
...
Changed: new `lib/trading-safety.js`, `agents/skills/trading/risk-manager.js`,
`agents/skills/trading/order-executor.js`, `bot/kalshi.js`,
`agents/skills/market-data/kalshi-market-data.js`, `agents/core/master-agent.js`,
...
Changed: `lib/ml-pipeline.js`, `bot/db.js`,
`agents/skills/analysis/ml-signal-scorer.js`, `server.js`, `.env.example`.
...
Added `scripts/start-demo.js`, `.env.demo.example`, `DEMO_BURN_IN.md`, and the `demo`
package script. Updated `.gitignore`, `bot/state.js`, `bot/db.js`,
`lib/ml-pipeline.js`, and `server.js` to isolate demo environment/data. The demo
