 ...
 *
 * NOTE: training data lives in local SQLite (bot/db.js) —
 * see lib/ml-pipeline.js. No remote "enabled" flag is needed;
...
class MLSignalScorer extends BaseSkill {
  ...
  async initialize(context) {
    ...
    // ml_features rows yet — see lib/ml-pipeline.js train().
    try {
