...
const { orderCost, affordableContracts } = require('../../../lib/trading-math');
      ...
      case 'evaluate-signals': {
        ...
        for (const signal of signals) {
          ...
          if (check.approved) {
            ...
            if(this.context.config?.ENABLE_TELEMETRY) require('../../../lib/research-telemetry').record('recordEvent','risk_rejection',{signal,reason:check.reason});
            // Log blocked signal
