...
const { HistoryStore } = require('../lib/market-history');
const { replay, asOf, fee, quote } = require('../lib/history-replay');
const { openResearch, downloadSpot, normalizeKline } = require('../lib/research-data');
...
function fixture(t, count = 10) {
  ...
  const config = { ...require('../research-config.json'), startingBalance: 1000,
