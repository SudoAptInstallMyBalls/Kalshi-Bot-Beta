...
const { HistoryStore, PublicHistoryClient, downloadHistory, exportCSVs, candlePrice, csvCell } = require('../lib/market-history');
const { authHeaders } = require('../scripts/record-market-history');
