...
class BinanceFeed {
  constructor(state, symbol = 'btcusdt') {
    ...
    this.restEndpoints = [
      { url: 'https://api.binance.us/api/v3/ticker/bookTicker', params: { symbol: symbol.toUpperCase() } },
      { url: 'https://api.binance.com/api/v3/ticker/bookTicker', params: { symbol: symbol.toUpperCase() } },
    ];
